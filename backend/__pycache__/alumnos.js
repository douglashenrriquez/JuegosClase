...
document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch("http://srv871982.hstgr.cloud:5001/api/clases")
        .then(res => res.json())
        .then(clases => {
    ...
    document.getElementById("formAlumno").addEventListener("submit", function (e) {
        ...
        if (isEditing) {
            // Actualizar alumno
            fetch(`http://srv871982.hstgr.cloud:5001/api/alumnos/${alumno.id}`, {
                method: "PUT",
            ...
            fetch("http://srv871982.hstgr.cloud:5001/api/alumnos", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify(alumno)
            })
...
function eliminarAlumno(id) {
    ...
    fetch(`http://srv871982.hstgr.cloud:5001/api/alumnos/${id}`, {
        method: "DELETE"
    })
    .then(res => res.json())
    .then(res => {
